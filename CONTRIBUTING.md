DubliBrowse contributors guide.


# DubliBrowse. Contributor's guidelines


# How to contribute

Great! DubliBrowse continues to improve from the contributions of its users. This could include code contributions, feature requests, and bug fixes for [DubliBrowse](https://github.com/scoute-dich/browser). 
Thank you for your interest in contributing to DubliBrowse. I appreciate all help with finding and fixing bugs, making performance improvements, and other tasks. Every contribution is helpful and I thank you for your effort. To ensure the process of contributing is as smooth as possible, here are a few guidelines for you to follow.
...
Your language isn't supported yet? You want to translate DubliBrowse? Or make improvements to existing translations? Feel free to use [crowdin](https://crowdin.com/project/foss-browser).
...
Fantastic. It's very rare for us to deny pull requests. Open a ticket to let other's know what you are working on along with a description. Fork the repository which in this case is [DubliBrowse](https://github.com/scoute-dich/browser), make your desired changes, and send a pull request.
...
1. Fork the repository of the project which in this case is [DubliBrowse](https://github.com/scoute-dich/browser)
 ...
 * I'll also need to know what version of DubliBrowse you're using and,
...
developer,  you can fork DubliBrowse and fix it yourself. 
...
***Thank you for your interest in contributing to DubliBrowse. I appreciate all the help with finding and fixing bugs, making performance improvements, and other tasks. Every contribution is helpful and I thank you for your effort.***
